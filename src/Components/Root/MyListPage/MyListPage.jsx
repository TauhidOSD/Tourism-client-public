          ...
          <div className="flex flex-col justify-between p-6 space-y-8">
            ...
            <div className="flex justify-between">
              ...
              <button onClick={()=> handleDelete(Card?._id)}
                type="button"
                className="   bg-orange-400 text-white  text-xl flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50"
                //   fdprocessedid="led2je"
              >
               Delete
              </button>
